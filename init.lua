...
require('lazy').setup({
  ...
  -- Main LSP Configuration
  {
    ...
    dependencies = {
      ...
      -- Add extra capabilities provided by nvim-cmp
      {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local toggle_symbol_hover = function()
          ...
          map('K', toggle_symbol_hover, 'Toggle symbol hover window')
  ...
  -- Autoformat
  {
    ...
    opts = {
      ...
      -- Keep empty line at the end of a file
      formatters = {
        ['*'] = {
          options = {
            trim_newlines = false,
